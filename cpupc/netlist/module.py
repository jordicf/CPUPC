...
class Module:
    ...
    def _check_consistency(self, kwargs: dict[str, Any]) -> None:
        ...
        assert (
            self.num_rectangles == 0 or self.center is None
        ...
        if self.flip:
            ...
            assert (
                self.is_hard and not self.is_fixed
        ...
        assert (
            self.is_hard or area_length_defined
