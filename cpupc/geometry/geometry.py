    ...
    def __init__(self, **kwargs: Any):
        ...
        for key, value in kwargs.items():
            match key:
                ...
                case KW.REGION:
                    assert (
                        valid_identifier(value) or value == KW.BLOCKAGE
